...
function AddUserPage() {
    const [user, setUser] = useState({ roleId: 0 });
    ...
    return (
        <div className='m-15'>
            <div className='flex flex-col sm:flex-row justify-center sm:justify-around mb-5 items-center'>
                ...
                <Link to='/login' >
                    <span className="rounded-md border border-blue-500 text-blue-600 font-bold px-4 py-1.5 hover:bg-blue-50 transition-colors">LogIn</span></Link>
            </div>
